...
//		$results = $this->model_catalog_product->getBestSellerProducts($setting['limit']);
        $results = $this->db->query("
                SELECT
                  ...
                  b.description
                 FROM
                 oc_product a LEFT JOIN oc_product_description b on a.product_id = b.product_id
                 WHERE a.is_best_sale = 1 AND a.status = 1
                  ORDER BY a.sort_order DESC LIMIT " . (int)$setting['limit']);
