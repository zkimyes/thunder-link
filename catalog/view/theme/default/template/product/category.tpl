                        ...
                        <div class="product-thumb">
                            ...
                            <div class="desc">
                                ...
                                <div class="button-group">
                                    <button class="btn btn-o-success" type="button" onclick="cart.add('{{product.product_id}}', '{{product.minimum}}');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button>
