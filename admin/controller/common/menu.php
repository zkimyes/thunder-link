...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        $data['download_category'] = $this->url->link('catalog/download/cindex', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['information_category'] = $this->url->link('catalog/informationcategory', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['solution_link'] = $this->url->link('solution/solution', 'token=' . $this->session->data['token'], 'SSL');
        $data['solution_category'] = $this->url->link('solution/category', 'token=' . $this->session->data['token'], 'SSL');
        $data['package'] = $this->url->link('package/package', 'token=' . $this->session->data['token'], 'SSL');
        $data['menuproduct'] = $this->url->link('catalog/menuproduct', 'token=' . $this->session->data['token'], 'SSL');


        $data['configs'] = $this->url->link('config/category', 'token=' . $this->session->data['token'], 'SSL');
        $data['config_items'] = $this->url->link('config/items', 'token=' . $this->session->data['token'], 'SSL');
        $data['config_boards'] = $this->url->link('config/board', 'token=' . $this->session->data['token'], 'SSL');
        $data['config_plan'] = $this->url->link('config/plan', 'token=' . $this->session->data['token'], 'SSL');


        $data['hotsale'] = $this->url->link('hotsale/index','token='.$this->session->data['token'],'SSL');
        $data['hotsale_products'] = $this->url->link('hotsale/index/products','token='.$this->session->data['token'],'SSL');
