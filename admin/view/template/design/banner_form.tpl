...
<div id="content">
  ...
  <div class="container-fluid">
          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-left" style="width: 30%"><textarea class="editbanner" id="banner_image[<?php echo $image_row; ?>]" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][description]" placeholder="description..." class="form-control"><?php echo isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['description'] : ''; ?></textarea></td>
    ...
    <script type="text/javascript"><!--
            $('.editbanner').summernote({
                height: 100
            });
        $('#images').on('click','.editbanner',function(){
            $(this).summernote({
                height: 100
            });
        })
...
function addImage() {
    ...
    html += '  <td class="text-left" style="width:300px;">';
	<?php foreach ($languages as $language) { ?>
	html += '    <div class="input-group">';
	html += '      <span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span><input type="text" name="banner_image[' + image_row + '][banner_image_description][<?php echo $language['language_id']; ?>][title]" value="" placeholder="<?php echo $entry_title; ?>" style="width:300px;" class="form-control" />';
    html += '    </div>';
	<?php } ?>
	html += '  </td>';	
	html += '  <td class="text-left"><input style="width: 200px;" type="url" name="banner_image[' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>';
    html += '  <td class="text-left"><textarea class="editbanner" type="text" name="banner_image[' + image_row + '][banner_image_description][<?php echo $language['language_id']; ?>][description]" value="" placeholder="description..." ></textarea></td>';
