...
--
-- Host: localhost
-- Generation Time: 2017-08-31 13:36:05
-- 服务器版本： 5.7.18
-- PHP Version: 5.6.30
...
(102, 7, 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'catalog/demo/banners/iPhone6.jpg', 0),
...
(61, '', 0, 0, 1, 0, 1, '2017-08-11 23:43:45', '2017-08-11 23:43:45'),
(62, '', 0, 0, 1, 0, 1, '2017-08-11 23:44:02', '2017-08-11 23:44:02'),
(60, '', 59, 1, 1, 0, 1, '2017-07-16 00:30:27', '2017-07-16 00:30:27'),
(59, '', 0, 1, 1, 0, 1, '2017-07-16 00:15:09', '2017-07-16 00:15:24');
...
(59, 1, 'transmission_network', '&lt;p&gt;&lt;br&gt;&lt;/p&gt;', 'transmission_network', 'transmission_network', 'transmission_network'),
(60, 1, 'osn 350', '&lt;p&gt;transmission_networktransmission_network&lt;br&gt;&lt;/p&gt;', 'transmission_network', 'transmission_network', 'transmission_network'),
(62, 1, 'asdasdasdasdasdasd', '&lt;p&gt;asdsadasdasdasd&lt;/p&gt;', 'asdasdasd', 'sadasdasdasdsad', 'asdasdasd'),
(61, 1, 'transmission_network', '&lt;p&gt;asdasdasd&lt;/p&gt;', 'asdasdasd', 'asdad', 'asdadasd');
...
--
-- 转存表中的数据 `oc_config_board`
--

INSERT INTO `oc_config_board` (`id`, `name`, `content`, `quantity`, `order`, `border_type_id`) VALUES
...
--
-- 转存表中的数据 `oc_config_board_type`
--

INSERT INTO `oc_config_board_type` (`id`, `name`, `type`, `order`) VALUES
...
--
-- 转存表中的数据 `oc_config_category`
--

INSERT INTO `oc_config_category` (`category_id`, `name`, `image`, `sort_order`, `description`, `meta_title`, `meta_description`, `meta_keyword`, `banner`) VALUES
...
--
-- 转存表中的数据 `oc_config_typical`
--

INSERT INTO `oc_config_typical` (`id`, `category_id`, `name`, `description`, `link_product_id`, `parameter`, `blueprint`, `link_boards`, `sort_order`) VALUES
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.77600002, 1, '2017-08-26 07:23:08'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2017-08-26 07:23:08'),
(3, 'Euro', 'EUR', '', '€', '2', 0.83819997, 1, '2017-08-26 07:23:08');
...
(30, 'Product 3', '', '', '', '', '', '', '', 6, 6, 'catalog/demo/canon_eos_5d_1.jpg', 9, 1, '0.0000', 0, 9, '2009-02-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 0, 1, 14, '2009-02-03 16:59:00', '2017-08-20 00:03:41'),
...
(42, 'Product 15', '', '', '', '', '', '', '', 990, 5, 'catalog/demo/apple_cinema_30.jpg', 8, 1, '1.0000', 400, 9, '2020-07-17', '12.50000000', 1, '1.00000000', '2.00000000', '3.00000000', 1, 1, 0, 0, 1, 13, '2009-02-03 21:07:37', '2017-08-19 22:59:13'),
...
(49, 'SAM1', '', '', '', '', '', '', '', 0, 8, 'catalog/demo/samsung_tab_1.jpg', 0, 1, '199.9900', 0, 9, '2011-04-25', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, 16, '2011-04-26 08:57:34', '2011-09-30 01:06:23');
...
(2390, 30, 'catalog/demo/canon_eos_5d_2.jpg', 0),
...
(2389, 30, 'catalog/demo/canon_eos_5d_3.jpg', 0),
...
(2388, 42, 'catalog/demo/canon_eos_5d_1.jpg', 0),
(2387, 42, 'catalog/demo/compaq_presario.jpg', 0),
(2386, 42, 'catalog/demo/hp_1.jpg', 0),
(2385, 42, 'catalog/demo/canon_logo.jpg', 0),
(2384, 42, 'catalog/demo/canon_eos_5d_2.jpg', 0);
...
--
-- 转存表中的数据 `oc_solution_category`
--

INSERT INTO `oc_solution_category` (`id`, `title`, `meta_keyword`, `meta_desc`, `url`) VALUES
...
--
-- 转存表中的数据 `oc_support_article`
--

INSERT INTO `oc_support_article` (`id`, `category_id`, `title`, `meta_title`, `meta_keywords`, `meta_desc`, `summary`, `content`, `createAt`, `image`, `banner_id`, `related_product_ids`, `is_comment`) VALUES
...
INSERT INTO `oc_support_category` (`id`, `title`, `meta_keyword`, `meta_desc`, `url`, `parent_id`) VALUES
...
--
-- 转存表中的数据 `oc_support_comments`
--

INSERT INTO `oc_support_comments` (`id`, `article_id`, `content`, `createAt`, `arthor`, `custom_id`, `status`) VALUES
...
INSERT INTO `oc_support_tags` (`id`, `name`, `is_search`, `is_hot`, `hot_level`) VALUES
(1, 'tagss', 1, 1, 5),
(2, 'dd', 1, 1, 10),
(3, 'ww', 1, 1, 1),
(4, 'ww22', 1, 1, 1),
...
--
-- 转存表中的数据 `oc_support_tag_relative`
--

INSERT INTO `oc_support_tag_relative` (`support_id`, `tag_id`) VALUES
(3, 7),
(3, 1),
(2, 5),
(2, 8);
...
(849, 'category_id=62', ''),
(845, 'category_id=60', ''),
(856, 'product_id=30', 'canon-eos-5d'),
...
--
-- Indexes for table `oc_category_solution`
--
ALTER TABLE `oc_category_solution`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `oc_config_board`
--
ALTER TABLE `oc_config_board`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `oc_config_board_type`
--
ALTER TABLE `oc_config_board_type`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `oc_config_category`
--
ALTER TABLE `oc_config_category`
  ADD PRIMARY KEY (`category_id`);

--
-- Indexes for table `oc_config_typical`
--
ALTER TABLE `oc_config_typical`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `oc_solution_article`
--
ALTER TABLE `oc_solution_article`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `oc_solution_category`
--
ALTER TABLE `oc_solution_category`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `oc_support_comments`
--
ALTER TABLE `oc_support_comments`
  ADD PRIMARY KEY (`id`);
...
--
-- 使用表AUTO_INCREMENT `oc_category_solution`
--
ALTER TABLE `oc_category_solution`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `oc_config_board`
--
ALTER TABLE `oc_config_board`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- 使用表AUTO_INCREMENT `oc_config_board_type`
--
ALTER TABLE `oc_config_board_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- 使用表AUTO_INCREMENT `oc_config_category`
--
ALTER TABLE `oc_config_category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
--
-- 使用表AUTO_INCREMENT `oc_config_typical`
--
ALTER TABLE `oc_config_typical`
...
--
-- 使用表AUTO_INCREMENT `oc_solution_article`
--
ALTER TABLE `oc_solution_article`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `oc_solution_category`
--
ALTER TABLE `oc_solution_category`
...
--
-- 使用表AUTO_INCREMENT `oc_support_comments`
--
ALTER TABLE `oc_support_comments`
